    ...
    try {
        ...
        if (!externalApiUrl) {
            ...
            if (eduType === "PhD") {
                ...
                externalApiUrl = `${baseUrl}/api/MasterList/MastersSpecialization/search`;
            } else if (eduType === "Graduate") {
                externalApiUrl = `${baseUrl}/api/MasterList/GraduateSpecialization/search`;
            }
        }
